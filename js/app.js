...
const progress = (() => {
    ...
    const progress = () => {
        // Set delay untuk memperlambat peningkatan nilai loaded
        setTimeout(() => {
            loaded += 1;
    
            bar.style.width = Math.min((loaded / total) * 100, 100).toString() + "%";
            info.innerText = `Loading  [${parseInt(bar.style.width).toFixed(0)}%]`;
        ...
        }, 500); // Ganti angka ini sesuai dengan jumlah milidetik yang diinginkan untuk menunda setiap peningkatan nilai loaded
    };
